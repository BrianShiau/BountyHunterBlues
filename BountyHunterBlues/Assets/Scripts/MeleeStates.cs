...
public class NeutralMelee: MeleeState {

	public NeutralMelee(MeleeEnemy enemy) : base(enemy) {}
...
public class AlertMelee: MeleeState {

	public AlertMelee(MeleeEnemy enemy) : base(enemy) { }
...
public class AggresiveMelee: MeleeState {
	...
	private static float shoot_timer_threshold = 0.5f;
